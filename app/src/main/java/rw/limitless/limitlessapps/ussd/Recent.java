...
public class Recent extends android.support.v4.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void submit_data() {
        if (isNetworkAvailable()) {
            try {
                ...
                String URL = "http://159.89.33.228:3000/api/get_recommended_service";
