...
public class Dashboard extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Dashboard.this, ClientRegistration.class);
                startActivity(intent);
            }
        });

        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_container);
        mSwipeRefreshLayout.setOnRefreshListener(Dashboard.this);
        ...
        if (sharedpreferences.getString("user_key", "").isEmpty()) {
            new AwesomeWarningDialog(this)
                    ...
                    .setWarningButtonClick(new Closure() {
                        ...
                        public void exec() {
                            // click
                            intent = new Intent(Dashboard.this, ClientRegistration.class);
                            startActivity(intent);
                        }
                    })
                    .show();
    ...
    public void submit_data() {
        if (isNetworkAvailable()) {
            try {
                ...
                String URL = "http://159.89.33.228:3000/api/get_my_services";
            ...
            try {
                if (!(exception == null)) {
                    ...
                    for (int i = 0; i < docs.length(); i++) {
                        ...
                        mRecycleView.setLayoutManager(new LinearLayoutManager(Dashboard.this));
                        mRecycleView.setAdapter(new ServiceAdapter(serivceVOList, new ServiceAdapter.OnItemClickListener() {
                            ...
                            public void onItemClick(Service_item item) {
                                Intent intent = new Intent(Dashboard.this, ServiceProfile.class);
